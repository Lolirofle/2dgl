...
impl<T: FloatMath> Vector2<T> for CoordVector2<T>{
...
impl<T: FloatMath + Sub<T,T> + One + core::fmt::Show> CoordVector2<T>{
...
impl<T: std::fmt::Show> std::fmt::Show for CoordVector2<T>{
